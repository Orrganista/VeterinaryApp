...
class ClientRestControllerTest {
    ...
    @Test
    @WithMockUser
    void getClientById_CorrectData_Returned() throws Exception {
        var client = new Client();
    ...
    void getAllClients_CorrectData_Returned() throws Exception {
        ...
        when(clientMapper.toClientResponseDtos(anyCollection())).thenReturn(List.of(clientResponse, clientResponse));
        ...
        verify(clientMapper).toClientResponseDtos(eq(clients));
    }
}
